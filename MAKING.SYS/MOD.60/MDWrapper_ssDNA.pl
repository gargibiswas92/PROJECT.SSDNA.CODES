...
#my ($scriptDirectory) = $0 =~ "/home_b/gargi/project_ssDNA/work/";                 # gets the directory of the execution
#my $utilDirectory = "/home_b/gargi/scripts/util/";        # path to ariel util directory 
my $utilDirectory = "/home_c/garima/scripts/util/";        # path to ariel util directory 
#my $utilDirectory = "/home_c/arielaz/scripts/util/";        # path to ariel util directory 
my $mdWrapperSchemaFileName = $scriptDirectory."/MDWrapper.prefs.schema";    # full path to ariel schema file 
#my $mdWrapperSchemaFileName = "/home_b/gargi/project_ssDNA/work/MDWrapper.prefs.schema";    # full path to ariel schema file 
my $mdWrapperPrefsFileName = "./MDWrapper1.prefs";
...
#  $executionPreferencesRef->{"Fexts_BUFFER"} = $executionPreferencesRef->{"Fexts"};
#  my @Fexts = split(/\,/,$executionPreferencesRef->{"Fexts_BUFFER"});
#  $executionPreferencesRef->{"Fexts"} = \@Fexts;
...
#    print MDW_LOG_FILE_HANDLE localtime(time),":Forces submitted: ",$executionPreferencesRef->{"Fexts_BUFFER"},"\n";
...
sub launchExecution
{
    ...
    print EXECUTION_SCRIPT_FILE_HANDLE "echo DEBUG MD is \$path\n";
