...
! ET is the total potential and kinetic energy 
      ...
      dimension DumE(15), Res(AN), count(NC)
      real RsBy
...
! these routines compute the forces
      ...
      call contacts(DumE(4), Conts, count)
       ...
       call stacking(DumE(10),DumE(11),DumE(12))
...
! calculate electrostatic force
     ...
     Q  X,Y,Z,Fx,Fy,Fz,esPairsNum,esDistanceCutoff,DumE(7),DumE(13),
     Q DumE(14),DumE(15),
