...
c          Lbead=((LastDNAbead+1)/2)+1
	   ...
	   FX(IN_B2)=FX(IN_B2)+Fext*0.621
	   FY(IN_B2)=FY(IN_B2)-Fext*0.126
	   FZ(IN_B2)=FZ(IN_B2)-Fext*0.773

	
	   FX(IN_B4)=FX(IN_B4)+Fext*0.511
	   FY(IN_B4)=FY(IN_B4)-Fext*0.539
	   FZ(IN_B4)=FZ(IN_B4)-Fext*0.669
