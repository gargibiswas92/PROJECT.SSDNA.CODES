...
c          Lbead=((LastDNAbead+1)/2)+1
	   ...
	   FX(IN_B2)=FX(IN_B2)+Fext*0.631
	   FY(IN_B2)=FY(IN_B2)-Fext*0.086
	   FZ(IN_B2)=FZ(IN_B2)-Fext*0.770

	
	   FX(IN_B4)=FX(IN_B4)+Fext*0.496
	   FY(IN_B4)=FY(IN_B4)-Fext*0.566
	   FZ(IN_B4)=FZ(IN_B4)-Fext*0.657
