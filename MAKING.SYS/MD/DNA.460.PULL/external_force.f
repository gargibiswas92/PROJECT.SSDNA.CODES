...
c          Lbead=((LastDNAbead+1)/2)+1
	   ...
	   FX(IN_B2)=FX(IN_B2)-Fext*0.758
	   FY(IN_B2)=FY(IN_B2)-Fext*0.202
	   FZ(IN_B2)=FZ(IN_B2)+Fext*0.619

	
	   FX(IN_B4)=FX(IN_B4)+Fext*0.738
	   FY(IN_B4)=FY(IN_B4)+Fext*0.240
	   FZ(IN_B4)=FZ(IN_B4)-Fext*0.630
