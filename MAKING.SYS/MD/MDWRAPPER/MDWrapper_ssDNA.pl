...
my $utilDirectory = "/home/gargi/Scripts/util/";        # path to ariel util directory 
...
#    print EXECUTION_SCRIPT_FILE_HANDLE "rm -r \$scratch\n";
    ...
    if ($executionPreferencesRef->{"EXECUTION_LOCATION"} =~ m/Cluster/i)
    {
      ...
      open(MDW_LOCK_FILE_HANDLE,"/home/gargi/Scripts/MDWrapper/ssdna/MDW.lock") or die "can't open the lock file: $!";
