...
!      enddo
      ...
      do i=1, AN
!      if(i.eq.firstDNABead.or.i.eq.2717)goto 742
      if(i.lt.firstDNABead.or.i.eq.2174.or.i.eq.4673
     &.or.i.eq.2519.or.i.eq.3083.or.i.eq.5083.or.i.eq.1796.or.i.eq.
     &3827.or.i.eq.4349)goto 742
      X(i) = X(i) + Vx(i)*tau
      Y(i) = Y(i) + Vy(i)*tau
      Z(i) = Z(i) + Vz(i)*tau
742   continue
