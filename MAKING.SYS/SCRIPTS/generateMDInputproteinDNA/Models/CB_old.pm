...
#  print $firstBeadRef->{"RADIUS"},$secondBeadRef->{"RADIUS"};
#   print "$repulsionDistance";
#  sleep(1);
...
################added by me for keeping protein fixed############################################
#      if($firstBeadRef->{"RESIDUE_INDEX"}+1 <= 448 and $secondBeadRef->{"RESIDUE_INDEX"} <= 448)
#      {next;}
#################################################################################################
      ...
      {
#        print $firstBeadRef->{"RESIDUE_INDEX"}+1 ,"\n";
#        print $secondBeadRef->{"RESIDUE_INDEX"},"\n";
#	print "yes \n";
	sleep(1);
