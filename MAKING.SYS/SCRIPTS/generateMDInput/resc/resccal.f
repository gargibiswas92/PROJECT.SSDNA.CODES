	...
	CHARACTER*4 ENPDB1
	CHARACTER*1  NAMCH(99000), NACH, NAMCHC,NNMCH,AA,NNMCHCC
	CHARACTER*6 DEF
	CHARACTER*3 NAMR(99000),NAMRC,LISTCOF(200),NNMAR,NMR
     2	,NAM3(20),NMF3,NAM3CC
	CHARACTER*2 DC1
	CHARACTER*10 DC2
	CHARACTER*1 ALET(10),CHNM
     2	,CMET(99000),CA1(99000),CA2(99000),CA3(99000),A1F
     3	,READI,LISTCH(200),ALET1(13)
	CHARACTER*1 NCHINSQ(10000),NMF1,NCHCOF(200)
	...
	INTEGER*2 COD(99000),SVA(99000),SVAR(167)
	...
	COMMON /CXYZ/	X(99000),Y(99000),Z(99000)
	...
	COMMON /NOC/	NOR1, NOR(99000)
	COMMON /SVC/	SVA
	COMMON /CSVT/	SVT
	COMMON /CRA/	RA(13), SN, ZN, SZP, SAP
	COMMON /NABEC/ 	NAB(10000),NAE(10000),NRINSQ(10000)
	COMMON /CXCR/	XCR(10000), YCR(10000), ZCR(10000), RDR(10000)
	COMMON /CCCOD/	COD
	COMMON /CNTYP/	NTYP
	COMMON /CNN1/	NA
 ...
 4883	FORMAT ('There is NO residue number', I5
  ...
  891	CONTINUE
	...
	CHARACTER*1  CMET(99000), CA1(99000), CA2(99000), CA3(99000)
     2              ,B4(995), B6(995), B7(995), B5(995), B11(995)
     3              , B15(995), BB7(995), BB8(995)
	CHARACTER*1  B2(995), NACH, NAMCH(99000),NMF1
	CHARACTER*3  B3(995), NAMR(99000), CDR, NMF3
	CHARACTER*50 FNAME
	CHARACTER*14 FNGFPDB1,FNGFPDB2
	CHARACTER*4  	LT(8), ENPDB, LT1, LT2
	CHARACTER*10 DN2
	CHARACTER*2  DC,DN1
	INTEGER*2    BCC(995), COD(99000), SVA(99000)
	INTEGER*4    B1(995), B8(995), NOR(99000)
 ...
 2026 FORMAT 
  ...
  400	CONTINUE
	...
	CHARACTER*3   NMR(100), B3(995), NMR1,NMF3,NAM3(20),TN
     K,NAMR(99000)
	CHARACTER*4  ENPDB
	INTEGER*4     NR(100),B1(995),B8(995),KP(100),NOR(99000)
